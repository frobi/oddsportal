...
# TEST cells_data_3way http://www.oddsportal.com/handball/ukraine/superleague/results/
...
# TEST get_data
c.get_data(['http://www.oddsportal.com/handball/ukraine/superleague/results/'],'bets.db3')
